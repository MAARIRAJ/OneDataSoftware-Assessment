...
import { addApplication,markAsApplied } from "../redux/jobSlice.js";
...
export default function ApplicationForm({ jobId, onClose ,onApplySuccess }) {
    ...
    <div className="container mt-4">
      ...
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          ...
          const aboutMeText = JSON.stringify(convertToRaw(contentState));
